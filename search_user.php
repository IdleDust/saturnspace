...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['listAllUser'])) {
        ...
        if (count($all_users) > 0) {
            echo '<div class="col-lg-10 col-md-10 col-sm-12"><table class="table table-striped"><thead><tr>' .
                '<th scope="col">#</th>' . '<th scope="col">First Name</th>' .
                '<th scope="col">Last Name</th>' . '<th scope="col">Email</th>' .
                '<th scope="col">Address</th>' . '<th scope="col">Home Phone</th>' .
                '<th scope="col">Cell Phone</th>' . '</tr>' . '</thead>' . '<tbody>';
            $i = 1;
